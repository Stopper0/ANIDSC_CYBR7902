...
def get_file_names(dataset, adv_files=False):
    if dataset.endswith("CICIDS-2017"):
        ...
        return ["benign_samples/whole_week"]+[f"attack_samples/{d}/{a}_{d}" for d, a in product(devices, attacks)]
