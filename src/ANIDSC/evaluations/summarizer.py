...
class BasicSummarizer:
    ...
    def plot_explainations(self, df, dataset, file, filename):
        # Plots embedded feature importance (both SHAP and LIME) across batches if anomaly score > threshold
        # Plots Node + Edge contribution to most important embedded features
